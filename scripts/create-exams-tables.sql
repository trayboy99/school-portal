...
-- Create student_exams table for storing marks
...
-- Create a view for broadsheet data
...
SELECT 
    ...
    se.grade,
    CASE 
        WHEN se.total < 50 THEN 'Below 50%'
        ELSE 'Above 50%'
...
-- Function to automatically calculate and update grades
